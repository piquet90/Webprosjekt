...
function overview() {
	...
	var text = "Det er her du velger hvilket spill du vil spille. Som du ser har vi bare ett spille her nå,"
...
function choose() {
	...
	document.getElementById("text").innerHTML = "La oss prøve ut FOBBALSPILLET! Trykk på <q>Trykk her for å spille</q>.";
